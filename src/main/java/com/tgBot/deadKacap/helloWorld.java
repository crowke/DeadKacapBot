...
public class helloWorld extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        "русс", "росси", "пидорас", "пидарас", "нихуя", "хуел", "пиздо", "понял", "перв", "еблан", "далее", "запрет",
        "меня", "добавь", "другой", "совсем", "тоже", "понятно", "брос", "освобо", "согл", "хотел", "наверно",
        "мальчик", "девочк", "здрасте", "здравствуй", "надеюс", "вреш", "скольк", "поздр", "разговари", "нрав"};
