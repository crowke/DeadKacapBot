...
public class helloWorld extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        String[] kacapWords = {"э", "ы", "ъ", "ё", "ьі", "привет", "дела", "что", "заебись", "тупой", "спасибо",
        "слушай", "тебя", "работ", "свободн", "ебат", "здарова", "почему", "ебал", "когда", "только", "почт", "пример",
        "русс", "росси", "пидорас", "пидарас", "нихуя", "хуел", "пиздо", "понял", "еблан", "далее", "запрет",
        "меня", "добавь", "другой", "совсем", "понятно", "брос", "освобо", "согл", "хотел", "наверно", "хуеть", "игра",
        ...
        if (message != null && (message.getChat().isGroupChat() || message.getChat().isSuperGroupChat())) {
            ...
            if (text.equals("/start") || text.equals("/start@deadkacapbot")) {
                ...
                send = send || text.contains("слава Україні".toLowerCase()) && setText("героям слава!", sm, message)
